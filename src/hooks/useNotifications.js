...
export function useNotifications() {
  // Instance-level state via useRef — each component gets its own isolated queue
  // and flush timer. Previously these were module-level variables shared across
  // all hook instances, causing cross-component notification corruption.
